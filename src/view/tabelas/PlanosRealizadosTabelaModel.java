 ...
 * @author Diogo
 */
public class PlanosRealizadosTabelaModel extends AbstractTableModel {

    private static final int IDENTIFICACAOPLANO = 0;
    private static final int DESCRICAOPLANO = 1;
    private static final int RESPONSAVEL = 2;
    private static final int DATALIMITE = 3;
    private static final int IDENTIFICACAORISCO = 4;
    private static final int TIPO = 5;
    private static final int DATAREALIZACAO = 6;

    // Array com os nomes das colunas.
    private String[] colunas = new String[]{"Identificacao", "Descrição", "Responsável", "Data Limite", "Risco", "Tipo de Plano", "Data de realização"};

    // Lista de Sócios a serem exibidos na tabela
    private List<PlanoTabela> linhas;

    // Cria um PlanoTabelaModel sem nenhuma linha
    public PlanosRealizadosTabelaModel() {
        linhas = new ArrayList<PlanoTabela>();
    }

    // Cria um PlanoTableModel contendo a lista recebida por parâmetro
    public PlanosRealizadosTabelaModel(List<PlanoTabela> listaDePlanoTabela) {
